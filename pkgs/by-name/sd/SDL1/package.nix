...
stdenv.mkDerivation (finalAttrs: {
  ...
  patches = [
    ...
    (fetchpatch {
      url = "https://src.fedoraproject.org/rpms/SDL/raw/7a07323e5cec08bea6f390526f86a1ce5341596d/f/SDL-1.2.15-Use-system-glext.h.patch";
      hash = "sha256-S2FWYPDsxx2RETuC7I5e+NC3NtUMPbp76l1DgZlGcpo=";
    })
  ];
